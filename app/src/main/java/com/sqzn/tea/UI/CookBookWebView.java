 ...
 * @describe 类描述：
 **/
public class CookBookWebView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cookbook_webview);

        String link ="https://m.douguo.com/cookbook/"+ getIntent().getStringExtra("id")+".html";
        Log.d(">>>      link",link);
